...
export default async function PremiumApartment() {
  ...
  return (
    <div className="bg-background pb-24 pt-24 md:pt-32">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        {/* Header Gallery */}
        <ViewItemTracker item={APARTMENTS.find(a => a.id.includes('premium'))!} />
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 mt-12 md:mt-16 relative">
          ...
          <div className="lg:w-1/3 relative mt-8 lg:mt-0">
            <div className="sticky top-32 z-20 h-fit">
              {/* @ts-ignore */}
              <hospitable-direct-property identifier="a20a137a-0c7e-42ba-8aa6-9c47accca90f" property="2302775"></hospitable-direct-property>
            </div>
          </div>
        </div>
      </div>
