...
import { wbadd9904Data } from "@/lib/checkinData";
import { t, type Lang } from "@/lib/wbadd9904Translations";
...
export default function Wbadd9904CheckIn() {
  ...
  const translatedSteps = wbadd9904Data.steps.map((step, i) => ({
    ...step,
      ...
      <main className="pt-24 pb-20 px-6 max-w-4xl mx-auto space-y-16">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <span className="text-foreground font-semibold md:text-lg">{wbadd9904Data.address}</span>
              </div>
            </div>
            <Link href={wbadd9904Data.mapUrl} target="_blank">
        ...
        <section ref={instructionsRef} className="space-y-8 scroll-mt-24">
          <div className="flex items-end justify-between border-b border-border/40 pb-6">
            ...
            <div className="hidden md:flex items-center gap-2 text-primary font-bold text-xs uppercase tracking-tight">
              {tx.arrivalFrom} {wbadd9904Data.checkInTime}
            </div>
          </div>
            ...
            <InfoCard title={tx.times} icon={Clock}>
              <div className="space-y-3">
                <div className="flex justify-between items-center bg-muted/30 p-2 rounded-lg">
                  ...
                  <span className="text-foreground font-bold">{wbadd9904Data.checkInTime}</span>
                </div>
                <div className="flex justify-between items-center bg-muted/30 p-2 rounded-lg">
                  <span className="text-xs font-bold uppercase text-muted-foreground">Check-out</span>
                  <span className="text-foreground font-bold">{wbadd9904Data.checkOutTime}</span>
                </div>
              </div>
            </InfoCard>
          </div>
        ...
        <section ref={contactRef} className="p-8 rounded-[2rem] bg-foreground text-background scroll-mt-24">
            ...
            <div className="space-y-4 flex-1">
              <div>
                <div className="flex items-center gap-3 mb-1">
                  <h2 className="font-serif text-2xl md:text-3xl font-bold">{wbadd9904Data.host.name}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-10">
            <Link href={`tel:${wbadd9904Data.host.phone}`}>
            ...
            <Link 
              href={`https://wa.me/${wbadd9904Data.host.phone.replace(/\+/g, "")}?text=${encodeURIComponent(tx.whatsappMessage)}`}
              target="_blank"
            >
